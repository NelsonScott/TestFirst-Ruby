...
describe RPNCalculator do
  ...
  it "resolves operator precedence unambiguously" do
    ...
    ##This seems like another error with testing, so I seperated them
    ##There didn't seem like any other way to 'reset' the @value without breaking
    ##The previous tests
...
##This did not seem to work properly so I commented it out to work on the EC
